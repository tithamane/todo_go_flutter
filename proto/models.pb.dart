...
class TodoServiceApi {
  ...
  $async.Future<TodoList> getAll($pb.ClientContext ctx, TodoFilter request) {
    var emptyResponse = TodoList();
    return _client.invoke<TodoList>(ctx, 'TodoService', 'GetAll', request, emptyResponse);
  }
  $async.Future<Todo> get($pb.ClientContext ctx, TodoParams request) {
    var emptyResponse = Todo();
    return _client.invoke<Todo>(ctx, 'TodoService', 'Get', request, emptyResponse);
  }
  $async.Future<RequestResult> add($pb.ClientContext ctx, Todo request) {
    var emptyResponse = RequestResult();
    return _client.invoke<RequestResult>(ctx, 'TodoService', 'Add', request, emptyResponse);
  }
  $async.Future<RequestResult> remove($pb.ClientContext ctx, TodoParams request) {
    var emptyResponse = RequestResult();
    return _client.invoke<RequestResult>(ctx, 'TodoService', 'Remove', request, emptyResponse);
  }
  $async.Future<RequestResult> update($pb.ClientContext ctx, Todo request) {
    var emptyResponse = RequestResult();
    return _client.invoke<RequestResult>(ctx, 'TodoService', 'Update', request, emptyResponse);
  }
}
